...
description: Expert knowledge for Microsoft Foundry Classic (aka Azure AI Foundry classic) development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building Foundry agents, configuring RAG/search, using tools (Functions/OpenAPI/MCP), routing models, or deploying hubs, and other Microsoft Foundry Classic related development tasks. Not for Microsoft Foundry (use microsoft-foundry), Microsoft Foundry Local (use microsoft-foundry-local), Microsoft Foundry Tools (use microsoft-foundry-tools).
...
|----------|-------|-------------|
| Troubleshooting | L33-L42 | Diagnosing and fixing Foundry classic issues: prompt flow compute, deployments/monitoring, private endpoints, Azure OpenAI (incl. fine-tuning), risks & safety alerts, and known portal bugs. |
| Best Practices | L43-L57 | Best practices for designing system/safety prompts, fine-tuning and using GPT/DeepSeek models, optimizing latency/throughput, and evaluating/operating Foundry chat apps in production |
| Decision Making | L58-L86 | Guidance on choosing models, regions, deployments, billing, and lifecycle strategies for Foundry and Azure OpenAI, including migration, PTU sizing, and cost/performance tradeoffs. |
| Architecture & Design Patterns | L87-L95 | Designing multi-agent architectures, configuring Foundry Agent Service for resilience, and understanding model router behavior, failover, and disaster recovery strategies. |
| Limits & Quotas | L96-L111 | Quotas, rate limits, and capacity for Foundry and Azure OpenAI (agents, models, deployments, regions), plus how to monitor, compare, request, and increase these limits. |
| Security | L112-L158 | Security, privacy, and compliance for Foundry: auth/RBAC, encryption and CMK, network isolation (VNets, Private Link, perimeters), Azure Policy guardrails, content filters, and data handling for models and tools. |
| Configuration | L159-L211 | Configuring, monitoring, and evaluating Foundry Classic/Models and Azure OpenAI resources, including agents, networking, storage, compute, RAG, safety, tracing, and continuous quality monitoring. |
| Integrations & Coding Patterns | L212-L331 | Integrating Foundry and Azure OpenAI with external data, tools, and SDKs: RAG with Search/SharePoint/files, tools (Functions, OpenAPI, MCP, browser, code), model routing, fine-tuning, realtime, and app frameworks. |
| Deployment | L332-L353 | Deploying Foundry hubs/models (CLI, portal, Bicep, Terraform), managed/serverless endpoints, region/feature availability, and integrating deployments/evaluations with DevOps and GitHub. |
