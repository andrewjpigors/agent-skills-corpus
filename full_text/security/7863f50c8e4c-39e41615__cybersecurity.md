...
name: cybersecurity
description: >
  AI-powered cybersecurity code review skill. Performs comprehensive
...
origin: AgriciDaniel/claude-cybersecurity (MIT, pinned commit bcc9638) — adapted, marketing footer/overclaims scrubbed
---

# Claude Cybersecurity — Code Security Audit
...
2. Check for OWASP Top 10:2025 + CWE Top 25:2024 violations using the
   authoritative category mapping in references/vulnerability-taxonomy.md
   (single source of truth — includes the 2025 additions A03 Software Supply
   Chain Failures and A10 Mishandling of Exceptional Conditions)
