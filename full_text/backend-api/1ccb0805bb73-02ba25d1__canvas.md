...
4. Name the token (e.g., "Monika"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.monika/.env`:
...
```bash
CANVAS="python $MONIKA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
