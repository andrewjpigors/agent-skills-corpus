...
2. **Indexes at every level.** Template: `.factory/skills/prd-templates/references/fractal-node-index-template.md`
3. **CX files at every level.** Template: `.factory/skills/prd-templates/references/fractal-cx-template.md`
4. **Feature files are leaf nodes.** Template: `.factory/skills/prd-templates/references/fractal-feature-template.md`
...
The top-level `ideation-index.md` uses a different template: `.factory/skills/prd-templates/references/ideation-index-template.md`
