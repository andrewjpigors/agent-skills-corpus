...
Same base model, different Skills loaded, becomes different experts.
...
2. If explaining something, ask: "Is this explaining TO the base model or FOR the base model?"
...
- Workflows the base model hasn't been trained on (new tools, proprietary systems)
...
**The test**:
1. Does it tell the agent WHAT to think about? (thinking patterns)
2. Does it tell the agent HOW to do things it wouldn't know? (domain procedures)
...
- WHEN: "When the agent needs to work with... for: (1)... (2)... (3)..."
...
- **[A] Activation**: The base model knows but brief reminder is useful — acceptable
...
- **Knowledge Delta**: Provides specific evaluation criteria the base model wouldn't generate on its own
