...
license: MIT
metadata:
  author: platform-design-skills (ehmo)
  version: "1.0.0"
  source: https://github.com/ehmo/platform-design-skills
  source-skill: web-design-guidelines
  maintainer: izo
  note: "Renommée de web-design-guidelines → web-platform-guidelines pour éviter la collision avec la skill vercel-labs/web-design-guidelines (review de code UI)."
---
