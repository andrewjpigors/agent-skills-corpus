...
description: "Apply for netlify-official-cursorrules-prompt-file. --- description: Guidelines and best practices for building Netlify projects & sites, including serverless functions, edge functions, functions, storage, and real-world examples globs: '**/*.{ts,tsx,j"
source: "cursorrules"
---
