---
name: insurance-marketing-plan
description: |
  Create marketing plans for insurance agencies.
  TRIGGERS - Use when user needs help with insurance-marketing-plan related tasks.
category: Insurance
version: 1.0
---
