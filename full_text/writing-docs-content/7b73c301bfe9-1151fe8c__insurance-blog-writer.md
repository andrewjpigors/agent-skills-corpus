---
name: insurance-blog-writer
description: |
  Write insurance blog content for SEO and education.
  TRIGGERS - Use when user needs help with insurance-blog-writer related tasks.
category: Insurance
version: 1.0
---
# insurance-blog-writer
## Workflow
