...
- User documentation: https://docs.nastechai.com/
- Source tree: https://github.com/NasTech/nastech-agent

## Quick Start

```bash
# Install
curl -fsSL https://nastechai.com/install.sh | bash
...
Platform docs: https://docs.nastechai.com/user-guide/messaging/
...
authoritative list or see the [live slash commands reference](https://docs.nastechai.com/reference/slash-commands).
...
Full config reference: https://docs.nastechai.com/user-guide/configuration
...
Full provider docs: https://docs.nastechai.com/integrations/providers
...
Synchronastech subagent spawn — the parent waits for the child's summary
...
User docs: https://docs.nastechai.com/user-guide/features/cron
...
User docs: https://docs.nastechai.com/user-guide/features/curator
...
User docs: https://docs.nastechai.com/user-guide/features/kanban
...
|----------------|----------|
| Config options | `nastech config edit` or [Configuration docs](https://docs.nastechai.com/user-guide/configuration) |
| Available tools | `nastech tools list` or [Tools reference](https://docs.nastechai.com/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](https://docs.nastechai.com/reference/slash-commands) |
| Skills catalog | `nastech skills browse` or [Skills catalog](https://docs.nastechai.com/reference/skills-catalog) |
| Provider setup | `nastech model` or [Providers guide](https://docs.nastechai.com/integrations/providers) |
| Platform setup | `nastech gateway setup` or [Messaging docs](https://docs.nastechai.com/user-guide/messaging/) |
| MCP servers | `nastech mcp list` or [MCP guide](https://docs.nastechai.com/user-guide/features/mcp) |
| Profiles | `nastech profile list` or [Profiles docs](https://docs.nastechai.com/user-guide/profiles) |
| Cron jobs | `nastech cron list` or [Cron docs](https://docs.nastechai.com/user-guide/features/cron) |
| Memory | `nastech memory status` or [Memory docs](https://docs.nastechai.com/user-guide/features/memory) |
| Env variables | `nastech config env-path` or [Env vars reference](https://docs.nastechai.com/reference/environment-variables) |
| CLI commands | `nastech --help` or [CLI reference](https://docs.nastechai.com/reference/cli-commands) |
...
For occasional contributors and PR authors. Full developer docs: https://docs.nastechai.com/developer-guide/
