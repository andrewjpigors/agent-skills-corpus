...
**Step 2: Append a `## Plan Review (Eng)` section** to the end of the plan file using the Edit tool. Include:

```markdown
## Plan Review (Eng)

**Reviewed**: [DATE] | **Mode**: [SCOPE REDUCTION / BIG CHANGE / SMALL CHANGE]

### Scope Decision
[One paragraph summarizing Step 0 outcome]
...
### Failure Modes
[Table from failure modes section, or "No critical gaps identified"]
...
**Rules:**
- If a `## Plan Review (Eng)` section already exists in the file, replace it (the review is being re-run).
