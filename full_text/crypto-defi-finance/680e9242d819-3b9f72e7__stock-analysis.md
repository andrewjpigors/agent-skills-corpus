...
- `stock_trading_costs`：基于盘口价差、成交额和换手率生成中低频再平衡成本 proxy；逐笔冲击、日内 ADV 曲线、ETF/指数期货对冲成本缺失时必须继续条件化。
...
专家视角不能忽略补充证据：若 Evidence Pack 提供补充证据、资讯事件、基金画像、持仓股精选资讯、公告/研报/资金流/短线情绪等内容，必须按该专家框架纳入对应章节的证据、风险或观察清单；证据缺失时必须写“证据不足，维持观察”，不得用专家口吻补全缺失数字。
