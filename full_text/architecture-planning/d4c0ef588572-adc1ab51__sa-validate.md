...
```bash
node ${CLAUDE_PLUGIN_ROOT}/nacl-core/scripts/classify-findings.mjs '{"findings":[{"check":"L1.1","severity":"CRITICAL"},{"check":"L4.1","severity":"CRITICAL","flags":{"field_category":"display"}}]}'
...
// ${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/provenance-gap-closure.md). Grandfathering is a last
