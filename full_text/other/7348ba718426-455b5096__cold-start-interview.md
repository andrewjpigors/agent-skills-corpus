...
> **Papel e nível de risco são avaliados por sistema, não por empresa.** No
> marco legal brasileiro (LGPD Art. 20 já em vigor + PL 2338/2023 ainda em
> tramitação), seu papel (fornecedor/desenvolvedor, operador/implementador,
> distribuidor) e o nível de risco são avaliados para cada sistema de IA
> separadamente — você pode ser operador de um sistema e fornecedor de
> outro. (Se sua pegada regulatória também inclui a UE, o mesmo raciocínio
> per-sistema se aplica sob o EU AI Act — provider/deployer/importer/
> distributor/authorized representative — como camada adicional, não
> substituta.) Em vez de atribuir um papel único em nível de empresa, vou
> montar um inventário de sistemas. Podemos fazer 1-3 sistemas agora e
> adicionar o resto depois com `/ai-governance-legal:ai-inventory add`. Ou
> pular o inventário por enquanto se ainda não estiver pronto.
...
**Regulatory footprint:** [Only list what actually applies — LGPD (Art. 20) /
PL 2338/2023 `[verify status]` / sector regulation (BCB/CMN, Anvisa, CVM) /
EU AI Act if operating in the EU / contractual requirements only]
