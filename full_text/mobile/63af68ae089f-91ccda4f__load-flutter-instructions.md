---
name: load-flutter-instructions
description: "Load Flutter/Dart best-practices guidelines; always apply when creating Flutter code. Helps the agent know to use these rules for writing, testing, and structuring Flutter apps."
---
