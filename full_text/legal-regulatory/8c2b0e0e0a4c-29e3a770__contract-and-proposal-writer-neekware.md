---
name: contract-and-proposal-writer-neekware
title: Contract & Proposal Writer
description: Drafts professional business documents including freelance contracts, proposals, SOWs, NDAs, and MSAs for US, EU, UK, and DACH jurisdictions. Use when starting client engagements or when jurisdiction-aware clauses like GDPR compliance are needed.
author: neekware
author_url: https://github.com/neekware/ehAyeSkills/tree/main/skills/business-growth/contract-and-proposal-writer
license: MIT
version: 0.1.0
execution_mode: open
