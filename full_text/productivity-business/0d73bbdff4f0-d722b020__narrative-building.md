...
composes_with:
  - package: "pm-skills"
    ...
    relation: "use_before"
    reason: "Narrative provides the story spine; executive-writing tightens it into exec-readable one-pagers, board memos, and decision briefs."
  - package: "pm-skills"
    skill: "multi-channel-publishing"
    relation: "use_before"
    reason: "Narrative is the source artifact; multi-channel-publishing repurposes it across LinkedIn, blog, brief, deck, and podcast script."
  - package: "pm-skills"
    skill: "product-strategy"
    relation: "use_after"
    reason: "Strategy defines what we bet on; narrative explains why now and to whom. Route from strategy -> narrative once the strategic bets are set."
  - package: "azure-skills"
    skill: "azure-deploy"
    relation: "use_after"
    reason: "Post-launch comms (announcement, customer notes, internal launch brief) draw on narrative. Route narrative after a successful deploy for launch communication."
  - package: "azure-skills"
    skill: "azure-diagnostics"
    relation: "use_after"
    reason: "Post-incident comms require narrative shaping — what happened, why it matters, what changed. Route narrative after azure-diagnostics output to author the public-facing story."
