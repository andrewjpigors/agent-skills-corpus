...
metadata:
  hermes:
    tags: [prompt-engineering, planning, requirements, document-generation, milk-tea, creative-expansion]
    related_skills: [milk-tea-ordering, hyper-concurrent-questioning, prompt-refiner, claude-code-goal-writer, ai-dev-flow, writing-plans]
---
