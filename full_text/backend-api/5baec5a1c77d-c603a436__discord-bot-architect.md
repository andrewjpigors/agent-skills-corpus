...
description: "Build production-ready Discord bots with Discord.js (JavaScript) and Pycord (Python) — gateway intents, slash commands, interactive components, rate limiting, and sharding. USE WHEN building, structuring, or scaling a Discord bot and choosing intents, commands, components, or a sharding strategy."
