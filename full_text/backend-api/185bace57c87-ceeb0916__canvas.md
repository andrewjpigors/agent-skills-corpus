...
4. Name the token (e.g., "Clawbot Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.clawbot/.env`:
...
```bash
CANVAS="python $CLAWBOT_HOME/skills/productivity/canvas/scripts/canvas_api.py"
