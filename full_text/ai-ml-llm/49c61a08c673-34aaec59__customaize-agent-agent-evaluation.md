...
description: Evaluate and improve OpenCode commands, skills, and agents. Use when testing prompt effectiveness, validating context engineering choices, or measuring improvement quality.
---

# Evaluation Methods for OpenCode Agents
...
```markdown
You are evaluating the output of an OpenCode agent.
...
For OpenCode development, ask users this:
...
When iterating on OpenCode prompts, evaluate systematically:
...
## Example: Evaluating an OpenCode Command
...
# LLM-as-Judge Implementation Patterns for OpenCode

This reference provides practical prompt patterns and workflows for evaluating OpenCode commands, skills, and agents during development.
...
```markdown
You are evaluating the output of an OpenCode command.
...
## Evaluation Workflows for OpenCode Development
