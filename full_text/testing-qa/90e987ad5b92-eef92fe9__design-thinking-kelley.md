...
description: >
  Human-centered design facilitation using David Kelley's IDEO/d.school methodology.
  Guides users through Empathize, Define, Ideate, Prototype, Test with Six Thinking Hats
  integration. Activates on product ideas, concept validation, user research, design sprints,
  or any problem-solving for real humans. Includes a quick-assessment mode for rapid feedback.
---
