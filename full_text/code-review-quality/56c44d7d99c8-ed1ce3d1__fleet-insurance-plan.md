---
name: fleet-insurance-plan
description: |
  Plan fleet insurance programs with vehicle management.
  TRIGGERS - Use when user needs help with fleet-insurance-plan related tasks.
category: Insurance
version: 1.0
---
# fleet-insurance-plan
## Workflow
