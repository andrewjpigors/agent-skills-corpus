...
- **Runs BEFORE:** Any writing begins (prose-craft)
- **Reads:** foundation.md (mandatory), reader-personas.md (mandatory), outline.md (mandatory), STATE.yaml (mandatory), research/bestseller-dna.md (optional), voice-bank/ (optional — existing samples from author or reference material)
- **Writes:** voice-dna.md at the project root
...
The following skills read `voice-dna.md`:
...
| **beta-reader** | Benchmark samples (Section 5) as comparison standard. Voice consistency scoring references voice-dna.md explicitly. |
