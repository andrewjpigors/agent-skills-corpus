...
**Epic Owner:** @{github_username}
**Estimated Completion:** Day {N} (End of Week {N})
**Status:** ⏳ PENDING
**Dependencies:** Epic {N} (✅ COMPLETE)
```
