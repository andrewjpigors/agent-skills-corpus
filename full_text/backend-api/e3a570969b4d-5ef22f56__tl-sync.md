...
Write `.tl/tasks/UC###/sync-report.md` using `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/templates/sync-report-template.md`.
...
Create `.tl/tasks/UC###/sync-report.md` using `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/templates/sync-report-template.md`.
...
| API contract format | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/api-contract-rules.md` |
| Stub tracking rules | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/stub-tracking-rules.md` |

## Templates

- `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/templates/sync-report-template.md` -- Sync report output format

## Examples

- `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/examples/sync-report-example.md` -- Complete sync report example
