...
name: anti-ai-exam
description: |
  Design AI-resistant exams for CS courses through adaptive consulting, adversarial auditing,
  and full exam generation. Helps professors create exams where AI-generated answers are
  detectably wrong, rewarding students who attend class and understand the material.
  Use when: professor wants to make exams AI-proof, audit exam questions against AI,
  design anti-cheating strategies, generate exam documents with built-in traps,
  or create grading rubrics with AI-detection scoring.
---
