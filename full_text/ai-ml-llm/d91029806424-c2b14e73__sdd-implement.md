...
- **Value of `.cek/plugins/sdd` so agents can resolve paths like `@.cek/plugins/sdd/scripts/create-scratchpad.sh`**
...
Read @.cek/plugins/sdd/prompts/judge.md for evaluation methodology.
