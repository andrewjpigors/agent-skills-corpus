...
## Arcen Agent Integration

This skill is designed for the Arcen agent. It uses Arcen tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Arcen skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.arcen/plans/` | `skill_view("plan")` |
