...
7. If web_search is unavailable, skip checks that require it and note: "web_search unavailable — proceeding with local-only analysis."
...
**Mental model:**
- Read copilot-instructions.md, README, key config files
