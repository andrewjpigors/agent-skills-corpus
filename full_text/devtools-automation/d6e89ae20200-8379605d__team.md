---
name: team
description: "[OMCP] N coordinated agents on shared task list using Copilot-native staged routing"
orchestrates-agents: "explore, planner, analyst, architect, critic, executor, debugger, designer, writer, test-engineer, verifier, security-reviewer, code-reviewer"
...
delegation and the plugin's state/MCP surfaces. The lead selects role-specific
agents for planning, PRD refinement, execution, verification, and fix loops.
