...
NeurIPS, ICML, and ICLR all require paper checklists. See conference-specific documentation for details.
...
**IMPORTANT**: Copy the ENTIRE directory, not just `main.tex`. Templates include:
...
**CRITICAL**: AI-generated citations have ~40% error rate. **Never write BibTeX from memory.**
...
- [ ] Step 1: Search using web search or Semantic Scholar API
...
**Step 0: Use Web Search for Initial Discovery**

Use available search tools to find relevant papers:
```
...
**APIs for Citation Verification:**
