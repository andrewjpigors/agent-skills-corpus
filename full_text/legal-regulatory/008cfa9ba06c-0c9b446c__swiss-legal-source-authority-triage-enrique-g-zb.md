...
title: Swiss Legal Source & Authority Triage
...
author_url: https://lawve.ai/en/skills/swiss-legal-source-authority-triage-enrique-g-zbinden
license: MIT
version: 0.1.0
execution_mode: open
jurisdiction: ch
...
40:["$","div",null,{"className":"relative z-10 mx-auto max-w-[1400px] px-4 pb-16 sm:px-8 lg:px-16","children":[["$","$L44",null,{"skillId":"a1b651e0-fbc9-4c6e-968f-a8edc5477d11","skillTitle":"Swiss Legal Source Authority Triage","skillStatus":"active","skillVisibility":"listed","slug":"swiss-legal-source-authority-triage-enrique-g-zbinden","shareToken":null,"settingsShareToken":null,"fileTree":["resources/","LICENSE.txt","README.md","resources/doctrine-and-expert-authority-map.md","resources/examples.md","resources/output-template.md","resources/source-hierarchy.md","resources/swiss-legal-source-map.md","SKILL.md"],"textContents":{"LICENSE.txt":"$45","README.md":"$46","resources/doctrine-and-expert-authority-map.md":"$47","resources/examples.md":"$48","resources/output-template.md":"$49","resources/source-hierarchy.md":"$4a","resources/swiss-legal-source-map.md":"$4b","SKILL.md":"$4c"},"fileSizes":{"LICENSE.txt":1067,"README.md":1680,"resources/doctrine-and-expert-authority-map.md":8543,"resources/examples.md":6985,"resources/output-template.md":2447,"resources/source-hierarchy.md":6629,"resources/swiss-legal-source-map.md":9865,"SKILL.md":13273},"hasShowcase":false,"hasSandbox":true,"canEdit":false,"isAdmin":false,"demoFiles":[],"sandboxConfig":{"steps":[{"type":"files","filesRequired":false}]},"initialDependencies":[],"initialMcpServers":[],"initialOauthConnections":[],"initialAccessGrants":[],"showcase":null,"about":{"locale":"en","sections":[{"title":"What this skill does","body":"Swiss legal source and authority triage. Use when a user asks a Swiss legal, regulatory, compliance, contract, employment, corporate, litigation, IP, tax, privacy, public-law, fintech, register, or cantonal-law question; when Swiss law may apply; or when an AI legal answer needs source routing across federal, cantonal, communal, regulator, register, contractual, professional, soft-law, multilingual, or open-data layers.\n"},{"title":"How to use","body":"The best way to start is to try it live right here — run it against your own document or question to see exactly how it operates, without any setup. Once you're comfortable, download the skill files and drop them into any AI assistant — Claude (Anthropic), ChatGPT (OpenAI), Gemini (Google), or Mistral. The same skill file works across all of them, so you are never locked into a single provider."}],"requiredSkills":[],"dependentSkills":[],"author":{"name":"Enrique G. Zbinden
