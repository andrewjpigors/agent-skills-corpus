...
name: ios
description: >
  Use this skill for ANY iOS or SwiftUI task. Triggers: SwiftUI, Swift, iOS, MVVM,
  @Observable, ViewModel, async/await, NavigationStack, Swift Concurrency, Xcode,
  UIKit interop, SF Symbols, CoreData, SwiftData, Keychain, UserDefaults, protocol-
  oriented design, Swift Testing, #Preview, accessibility, VoiceOver, Liquid Glass,
  iOS 26, or any task involving creating, editing, debugging, or reviewing iOS/Swift
  code. Also trigger when the user asks to build an iOS app, add an iOS feature, or
  create a screen — even without saying "iOS." This is the ONLY skill needed for iOS
  projects. Read it BEFORE writing any iOS/Swift code.
---
