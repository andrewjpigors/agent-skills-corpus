---
name: insurance-onboarding-client
description: |
  Design client onboarding for insurance.
  TRIGGERS - Use when user needs help with insurance-onboarding-client related tasks.
category: Insurance
version: 1.0
---
# insurance-onboarding-client
## Workflow
