...
for PLAN_DIR in "$HOME/.gstack/projects/$_PLAN_SLUG" "$HOME/.claude/plans" "$HOME/.kit/plans" ".gstack/plans"; do
  [ -d "$PLAN_DIR" ] || continue
...
════════════════════════════════════════════════════════════
  ...
  Unique to KIT: [from codex adversarial or code review, if ran]
