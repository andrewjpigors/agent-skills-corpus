...
metadata:
  clawbot:
    ...
    homepage: https://github.com/aayushsoam/baoyu-skills#baoyu-infographic
---

# Infographic Generator

Adapted from [baoyu-infographic](https://github.com/aayushsoam/baoyu-skills) for Clawbot Agent's tool ecosystem.
