---
name: client-onboarding-insurance
description: |
  Design client onboarding processes for insurance.
  TRIGGERS - Use when user needs help with client-onboarding-insurance related tasks.
category: Insurance
version: 1.0
---
# client-onboarding-insurance
## Workflow
