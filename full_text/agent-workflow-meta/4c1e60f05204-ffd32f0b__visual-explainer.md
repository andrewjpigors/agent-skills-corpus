...
Detailed prompt templates are in `./commands/`. Command invocation style varies by runtime (slash commands, namespaced commands, or prompt invocation). Use the equivalent command format supported by your environment.
