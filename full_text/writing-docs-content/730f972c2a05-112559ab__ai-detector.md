...
name: ai-detector
description: >
  Analyze any text to detect signs of AI-generated writing and produce a detailed
  AI probability score with breakdown. Use this skill whenever the user wants to:
  check if text was written by AI, score text for AI likelihood, detect AI patterns,
  run AI detection on a draft, check if something "passes" AI detection, audit text
  before submitting, or test whether writing sounds human. Also trigger when the user
  mentions "AI detector", "AI detection", "detect AI", "AI score", "AI check",
  "is this AI", "does this sound like AI", "will this pass", "AI scan", "check for AI",
  "run detection", "was this humanized", "humanized AI", or pastes text asking if it
  looks AI-generated. This skill ONLY detects and scores — it does NOT rewrite. If the
  user wants rewrites, use the humanizer skills instead.
---
