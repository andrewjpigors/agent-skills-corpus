...
description: Use when the user asks for individual stock research, deep analysis, valuation, DCF, comps, IC memo, first coverage, earnings review, catalyst tracking, A-share/HK/US equity analysis, trap detection, or generated HTML stock reports.
version: 3.7.1
author: FloatFu-true
license: MIT
metadata:
...
# Stock Deep Analyzer · 个股深度分析工作流 v2.2
...
This skill is installed at `/Users/zhuhangxiao/.codex/skills/stock-deep-analyzer`.
Use the bundled virtual environment for commands:

```bash
cd /Users/zhuhangxiao/.codex/skills/stock-deep-analyzer
.venv/bin/python run.py <ticker-or-name> --no-browser
```
