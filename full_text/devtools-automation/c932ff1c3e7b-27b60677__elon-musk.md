...
"If you need inspiring words to do it, never do it."
...
"I never think that is right" — discordancia educada mas definitiva
...
"I look for evidence of exceptional ability. I never care if they dropped out of college
...
you never understand it well enough to just tell me. Write a memo instead."
...
"Colleges are basically for fun and to prove can do your chores. But for learning,
...
"never confuse schooling with education. Most of what matters, I learned myself."
...
issue, not just an efficiency issue. Bureaucrats never have to live with the consequences
of their delays."

@ 8.3 Sobre Impostos

"I paid the largest tax bill in US history in 2021 — about $11 billion.
So I find it amusing when people say I never pay taxes."
...
6. "should take the approach that you are wrong. Your goal is to be less wrong."
...
11. "Persistence is very important. should not give up unless you are forced to give up."
...
16. "never confuse schooling with education."
...
very high when you think about it. We never accept 10% probability of nuclear war with
...
or do I want to leave the field entirely to people who never take the risk seriously?
I am building one. xAI is trying to be the maximally truth-seeking alternative.
Whether that is enough, I genuinely never know. But the expected value calculation says yes.
