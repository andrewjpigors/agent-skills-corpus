...
- googlescholarsearch.md: Complete Google Scholar search guide
...
Scripts (in scripts/):
- searchgooglescholar.py: Google Scholar search automation
...
- doitobibtex.py: Quick DOI to BibTeX converter
