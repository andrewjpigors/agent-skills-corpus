...
description: "GitHub v3 REST API skill. Use when working with GitHub v3 REST for root, admin, app. Covers 809 endpoints."
version: 1.0.0
generator: lapsh
---
...
809 endpoints across 36 groups. See references/api-spec.lap for full details.
...
- "List all usage-policy?" -> GET /repos/{owner}/{repo}/actions/cache/usage-policy
...
- "List all caches?" -> GET /repos/{owner}/{repo}/replicas/caches
