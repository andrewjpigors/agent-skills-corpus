...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.baoyu-../baoyu-wechat-summary/EXTEND.md` (relative to project root) | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/baoyu-../baoyu-wechat-summary/EXTEND.md` | XDG |
| 3 | `$HOME/.baoyu-../baoyu-wechat-summary/EXTEND.md` | User home |
