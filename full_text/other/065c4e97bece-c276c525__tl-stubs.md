...
**UC scan**: write `.tl/tasks/UC###/stub-report.md` using `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/templates/stub-report-template.md`. Sections: frontmatter (task_id, scan_date, status, counts), summary, critical/warning/info/orphaned stubs, empty-test-file count with file list, blocking status, recommendations, registry update note.
...
| Topic | Reference |
|-------|-----------|
| Stub tracking rules (full) | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/stub-tracking-rules.md` |
| Stub report template | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/templates/stub-report-template.md` |
| TL protocol | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/tl-protocol.md` |
| FE code patterns | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/fe-code-style.md` |
