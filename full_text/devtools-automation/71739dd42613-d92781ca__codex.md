...
metadata:
  monika:
    ...
    related_skills: [claude-code, monika-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Monika terminal. Codex is OpenAI's autonomous coding agent CLI.
