...
7. **Ensure directories exist**:
   ...
   ```bash
   bash .cek/plugins/sdd/scripts/create-folders.sh
   ```
...
3. **Provide the value of `.cek/plugins/sdd` so agents can resolve paths like `@.cek/plugins/sdd/scripts/create-scratchpad.sh`**
...
- **Prompt**:
  ...
  ```
  CLAUDE_PLUGIN_ROOT=.cek/plugins/sdd
...
- **Prompt**:
  ...
  Read .cek/plugins/sdd/skills/plan/analyse-business-requirements.md and execute it exactly as is!
...
- **Prompt**:
  ...
  Read @.cek/plugins/sdd/prompts/judge.md for evaluation methodology and execute.
