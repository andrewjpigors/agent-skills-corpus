---
name: shopify-apps
description: "Build Shopify apps — Remix/React Router embedded apps with App Bridge, GraphQL Admin API, webhooks, Polaris UI, billing, and app extensions. USE WHEN creating or extending a Shopify app, webhook, or storefront integration."
...
> Upstream source: vibeship-spawner-skills (Apache 2.0) · packaged via antigravity-awesome-skills (MIT)
