...
description: "Build agents that operate a computer like a human, viewing screens and clicking/typing, across Anthropic Computer Use, OpenAI Operator/CUA, and open-source alternatives. USE WHEN building an agent that drives a GUI via screenshots and mouse/keyboard control."
