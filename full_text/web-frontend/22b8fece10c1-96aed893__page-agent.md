...
- User wants **Clawbot itself to drive a browser** → use Clawbot' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
