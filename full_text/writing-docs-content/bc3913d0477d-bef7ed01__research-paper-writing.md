...
This skill synthesizes writing philosophy from researchers who have published extensively at top venues. The writing philosophy layer was originally compiled by [Aayush Soam](https://github.com/aayushsoam) as the `ml-paper-writing` skill.
...
## Clawbot Agent Integration

This skill is designed for the Clawbot agent. It uses Clawbot tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Clawbot skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.clawbot/plans/` | `skill_view("plan")` |
