...
- Copy the prompt to clipboard using the bundled script `scripts/copy-to-clipboard.sh`, resolved relative to this skill's directory
  ```bash
  scripts/copy-to-clipboard.sh "prompt text here"
  ```
