...
From the `agentic-engineering` plugin (examples):

### Review Agents
```javascript
// Security review
Task({
  subagent_type: "agentic-engineering:review:security-sentinel",
...
// Performance review
Task({
  subagent_type: "agentic-engineering:review:performance-oracle",
...
// Rails code review
Task({
  subagent_type: "agentic-engineering:review:kieran-rails-reviewer",
...
// Architecture review
Task({
  subagent_type: "agentic-engineering:review:architecture-strategist",
...
// Code simplicity
Task({
  subagent_type: "agentic-engineering:review:code-simplicity-reviewer",
  description: "Simplicity check",
  prompt: "Check if this implementation can be simplified"
})
```

**All review agents from agentic-engineering:**
...
Task({
  subagent_type: "agentic-engineering:research:best-practices-researcher",
...
Task({
  subagent_type: "agentic-engineering:research:framework-docs-researcher",
...
Task({
  subagent_type: "agentic-engineering:research:git-history-analyzer",
...
```javascript
Task({
  subagent_type: "agentic-engineering:design:figma-design-sync",
...
```javascript
Task({
  subagent_type: "agentic-engineering:workflow:bug-reproduction-validator",
