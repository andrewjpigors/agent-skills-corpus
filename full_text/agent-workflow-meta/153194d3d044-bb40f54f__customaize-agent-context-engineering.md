...
This section transforms context degradation detection and mitigation concepts into actionable multi-agent workflows for OpenCode. Use these patterns when building commands, skills, or complex agent pipelines to ensure quality and reliability.
...
### Applying Optimization to OpenCode Prompts
