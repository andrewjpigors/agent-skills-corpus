...
framing is Vineet's #1 explicitly: "don't waste your time reviewing
...
3. **Static Analyzer Pre-Check** (always; specific sub-tools depend on what
   ...
   Vineet's Code Review Guide #7 explicitly says review these findings
...
reviewer sees Vineet's #7 in one place rather than scattered across bot comments.
...
- **Vineet priority order is the human-reviewer standard.** Vineet Kumar's
  ...
  without further specialist dispatch, matching Vineet's "don't waste your
