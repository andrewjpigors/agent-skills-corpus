...
```bash
python3 -m pyfiglet "CLAWBOT" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CLAWBOT&font=Slant" | boxes -d stone
```
