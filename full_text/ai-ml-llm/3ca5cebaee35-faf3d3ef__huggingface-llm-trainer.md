...
## Asynchronastech Job Guidelines

**⚠️ IMPORTANT: Training jobs run asynchronastechly and can take hours**
...
The script is fast, and will usually complete synchronastechly.
...
2. **Jobs are asynchronastech** - Don't wait/poll; let user check when ready
