...
description: >
  Robot perception best practices for cameras, LiDARs, depth sensors, IMUs, and multi-sensor
  pipelines. Use when working with OpenCV, Open3D, PCL, RealSense, ZED, OAK-D, RGBD, point
  clouds, calibration, AprilTags, ArUco, detection, segmentation, tracking, frame
  synchronization, coordinate transforms, perception latency, or production deployment of
