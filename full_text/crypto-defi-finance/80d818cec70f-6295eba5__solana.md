...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by Clawbot Agent
license: MIT
metadata:
  clawbot:
...
Helper script path: ~/.clawbot/skills/blockchain/solana/scripts/solana_client.py
...
```bash
python3 ~/.clawbot/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.clawbot/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.clawbot/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.clawbot/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.clawbot/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
