...
description: "Run workloads on Hugging Face Jobs with managed CPUs, GPUs, TPUs, secrets, and Hub persistence, with no local setup. USE WHEN you need to run a training or batch workload on managed Hugging Face cloud compute."
