...
## Lastochka Integration

This skill is designed for the Lastochka. It uses Lastochka tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Lastochka skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.lastochka/plans/` | `skill_view("plan")` |
