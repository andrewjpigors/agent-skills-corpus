...
This skill is designed for the ZedClaw. It uses ZedClaw tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other ZedClaw skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.zedclaw/plans/` | `skill_view("plan")` |
