...
description: "Test and benchmark LLM agents with behavioral contract testing, capability assessment, statistical/adversarial evaluation, regression pipelines, and production monitoring. USE WHEN you need to measure, benchmark, or regression-test an LLM agent's real-world reliability."
