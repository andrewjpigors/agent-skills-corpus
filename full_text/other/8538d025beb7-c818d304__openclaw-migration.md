...
- copy OpenClaw skills into `~/.myai/skills/openclaw-imports/`
- optionally copy the OpenClaw workspace instructions file into a chosen MyAIOne workspace
- mirror compatible workspace assets such as `workspace/tts/` into `~/.myai/tts/`
...
- `~/.myai/skills/migration/openclaw-migration/scripts/openclaw_to_myaione.py`

Do not guess a shorter path like `~/.myai/skills/openclaw-migration/...`.

Before running the helper:

1. Prefer the installed path under `~/.myai/skills/migration/openclaw-migration/`.
...
```bash
python3 ~/.myai/skills/migration/openclaw-migration/scripts/openclaw_to_myaione.py
```
...
```bash
python3 ~/.myai/skills/migration/openclaw-migration/scripts/openclaw_to_myaione.py --preset user-data
```

Execute a user-data migration:

```bash
python3 ~/.myai/skills/migration/openclaw-migration/scripts/openclaw_to_myaione.py --execute --preset user-data --skill-conflict skip
```

Execute a full compatible migration:

```bash
python3 ~/.myai/skills/migration/openclaw-migration/scripts/openclaw_to_myaione.py --execute --preset full --migrate-secrets --skill-conflict skip
```

Execute with workspace instructions included:

```bash
python3 ~/.myai/skills/migration/openclaw-migration/scripts/openclaw_to_myaione.py --execute --preset user-data --skill-conflict rename --workspace-target "/absolute/workspace/path"
```
...
- OpenClaw skills available under `~/.myai/skills/openclaw-imports/`
