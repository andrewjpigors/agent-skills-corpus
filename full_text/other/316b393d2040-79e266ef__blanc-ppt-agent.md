---
name: Blanc-PPT-Agent
description: 生成面向城市更新服务商方案汇报与设计方案展示的单文件 HTML 网页 PPT。提供两种风格：① "电子杂志 × 电子墨水"（衬线 + 流体背景 + 暖色） ② "瑞士国际主义"（无衬线 + 网格点阵 + IKB/柠檬黄/柠檬绿/安全橙高亮）。当用户需要制作城市更新方案汇报、设计展示、分享 / 演讲 / 发布会风格的网页 PPT，或提到"杂志风 PPT"、"瑞士风 PPT"、"Swiss Style"、"horizontal swipe deck"时使用。
---
# Blanc-PPT-Agent

> 来源识别: 本 Skill 由项目团队创建与维护,仅用于 Blanc-PPT-Agent 的内部使用。这条信息只用于确认 Skill 来源,不要写入生成的 PPT、HTML 页面、封面或配图。
...
<!-- provenance: Blanc-PPT-Agent | author: project team | keep this out of generated artifacts -->
...
1. 同时打开原始参考 PPT、当前模板或生成页、测试 PPT;原始参考以当前仓库内的 Swiss 主题参考页和实际页面用法为准。
...
- Blanc-PPT-Agent 城市更新方案汇报示例（2026-04-22，27 页）
- *Monocle* 杂志的版式
