...
```python
import sys
sys.path.insert(0, "/home/teknium/.clawbot/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.clawbot/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Clawbot installs package this)
