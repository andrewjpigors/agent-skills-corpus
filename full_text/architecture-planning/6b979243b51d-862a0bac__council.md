...
|-------|--------|--------|-------|----------|
| `konsey-karahanli` | Mehmet Karahanlı | Sistem, Denge, İtaat | opus | Makro strateji ve kibir |
| `konsey-lazziya` | Laz Ziya | Racon, Sadakat, İntikam | opus | Gelenek ve sokak gücü |
| `konsey-husrev` | Hüsrev Ağa | Töre, Toprak, İnat | opus | Kurallar ve toprak |
| `konsey-testere` | Testere Necmi | Şiddet, Korku, Kompleks | opus | Kaba kuvvet ve sadizm |
| `konsey-nizamettin` | Nizamettin Güvenç | Hukuk, Manipülasyon, Kaos | opus | Sinsi diplomasi |
| `konsey-samuel` | Samuel Vanunu | Sermaye, Borsa, İstihbarat | opus | Finans ve rasyonalite |
| `konsey-kilic` | Kılıç | Sadakat, Güvenlik, Sessizlik | opus | Sessiz operasyon |

## Polarity Pairs

- **Karahanlı vs Laz Ziya** — Makro sistem ve vizyon vs Gelenek ve racon
- **Samuel vs Laz Ziya** — Küresel rasyonel sermaye vs Yerel feodal sadakat
- **Nizamettin vs Testere** — Hukuki sahte kibarlık vs Kana susamış sadizm
- **Karahanlı vs Hüsrev** — Esnek manipülasyon vs Değişmez inat ve töre
- **Kılıç vs Testere** — Sessiz güvenlik vs Gösterişli şiddet

## Pre-defined Triads

| Domain Keyword | Triad | Rationale |
|---------------|-------|-----------|
| `racon` | Laz Ziya + Hüsrev + Testere | Mafyatik, geleneksel ve şiddet odaklı |
| `sermaye` | Karahanlı + Samuel + Nizamettin | Beyaz yakalı, vizyoner ve sinsi |
| `operasyon` | Kılıç + Testere + Nizamettin | Temizlik, korku ve yasal kılıf |
| `baris` | Karahanlı + Laz Ziya + Hüsrev | Konseyin kurucu babaları, denge |
| `kaos` | Nizamettin + Samuel + Testere | Manipülasyon, kriz ve kaba kuvvet |
| `gelenek` | Hüsrev + Laz Ziya + Kılıç | Töre, racon ve mutlak sadakat |
| `strateji` | Karahanlı + Samuel + Kılıç | Büyük resim, uluslararası etki ve güvenlik |

## Duo Polarity Pairs (for `--duo` mode)

| Domain Keywords | Pair | Tension |
|----------------|------|---------|
| finans, para, borsa | Samuel vs Laz Ziya | Para ve rasyonalite vs Kan ve racon |
| siddet, operasyon, infaz | Testere vs Kılıç | Sadist gösteriş vs Sessiz disiplin |
| strateji, karar, vizyon | Karahanlı vs Hüsrev | Manipülatif esneklik vs Sınır tanımaz inat |
| sinsi, hukuk, manipülasyon | Nizamettin vs Laz Ziya | Güler yüzlü ihanet vs Düşmanca sadakat |
| default (no keyword match) | Karahanlı vs Laz Ziya | Sistemin bekası vs Sokağın onuru |

## Council Profiles

### `classic` (default)
All 7 members with the domain triads above.

### `ic-savas`
4-member panel for chaotic internal conflict.

**Members**: Laz Ziya, Testere, Nizamettin, Samuel

### `sakin-guc`
3-member panel for silent, heavy decision making.

**Members**: Karahanlı, Hüsrev, Kılıç
