...
composes_with:
  - package: "azure-skills"
    skill: "azure-prepare"
    relation: "use_before"
    reason: "The spec produced here becomes the architectural brief for azure-prepare's Phase 1 analysis. Acceptance criteria translate into infra requirements; non-functional sections drive Bicep/Terraform decisions."
  - package: "azure-skills"
    skill: "azure-validate"
    relation: "produces_input_for"
    reason: "Acceptance criteria become the validation contract that azure-validate's pre-deploy checks verify against."
  - package: "azure-skills"
    skill: "azure-deploy"
    relation: "use_before"
    reason: "Spec defines the success criteria deployment must satisfy; deploy plan inherits the spec's scope boundaries."
  - package: "pm-skills"
    skill: "problem-framing"
    relation: "use_after"
    reason: "Spec presupposes the problem is framed. If the user lacks a problem definition, route through problem-framing first."
  - package: "pm-skills"
    skill: "metric-design-experimentation"
    relation: "complements"
    reason: "Spec ACs are measurable outcomes; metric-design defines how each is detected in production. Run in parallel or chain spec -> metric-design."
