---
name: ecom-adds
description: Generate 4 scroll-stopping e-commerce ad creatives for a product using deep customer research, competitor ad analysis via Facebook Ads Library, reference image sourcing via Tavily, and image generation via Nano Banana 2 (Gemini). Use when the user asks to create ads, ad creatives, DTC ads, Facebook/Instagram ads, or generate advertising images for a product.
---
