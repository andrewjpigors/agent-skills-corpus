...
composes_with:
  - package: "azure-skills"
    ...
    reason: "Event schema + named metrics defined here are consumed by appinsights-instrumentation to wire live telemetry on Azure-hosted apps."
  - package: "azure-skills"
    skill: "azure-kusto"
    relation: "complements"
    reason: "Metric decomposition tree drives KQL query templates; the NSM hierarchy becomes a Kusto query library for ongoing measurement."
  - package: "pm-skills"
    skill: "specification-writing"
    relation: "use_after"
    reason: "Spec outcomes need measurable metrics — metric-design follows specification-writing to define how each acceptance criterion is detected in production."
  - package: "pm-skills"
    skill: "product-strategy"
    relation: "complements"
    reason: "Strategic bets need NSMs; metric-design operationalizes how each strategic outcome is measured. Pair strategy NSM with metric-design decomposition."
  - package: "pm-skills"
    skill: "discovery-research"
    relation: "complements"
    reason: "Discovery-research output (validated hypotheses, evidence gaps) often feeds A/B experiment design — metric-design picks up where discovery ends."
