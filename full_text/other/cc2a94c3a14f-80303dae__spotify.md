...
Control the user's Spotify account via the Clawbot Spotify toolset (7 tools). Setup guide: https://clawbot-agent.aayushsoam.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `clawbot auth spotify` again.
