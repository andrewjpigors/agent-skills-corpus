...
description: >
  Design comprehensive, modern, professional, and polished mobile app user interfaces that look
  like the top apps in the App Store and Play Store — think Airbnb, Spotify, Duolingo, Revolut,
  or Phantom. Use this skill whenever the user asks to design, create, build, mockup, prototype,
  or visualize any mobile app screen, flow, or component — including dashboards, onboarding flows,
  detail screens, home screens, settings pages, auth screens, chat interfaces, finance apps, health
  apps, productivity tools, crypto/Web3 apps, e-commerce screens, or any mobile UI element. Trigger
  even for partial requests like "make a mobile screen for X", "design an app for Y", "show me what
  this app might look like", "create a UI for Z", "improve this screen", or "make it look like
  Spotify/Airbnb". Always use this skill when the output is a rendered mobile UI.
---
