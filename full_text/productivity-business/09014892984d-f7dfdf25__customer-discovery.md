...
**Phase 3 — Focused interview.** Ask 1–3 questions per turn via `AskUserQuestion`. Research and recommend by default — present options with a recommended default. Continue until all areas that shape candidate generation and framework selection are covered or the user signals enough.
