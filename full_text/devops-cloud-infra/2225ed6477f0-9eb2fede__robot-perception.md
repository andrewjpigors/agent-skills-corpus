...
description: Use when working with robot perception — camera/LiDAR/depth sensor setup, calibration (intrinsic, extrinsic, hand-eye), image processing, point clouds, object detection, sensor streaming, multi-sensor synchronization, or perception pipeline deployment.
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [robotics, perception, camera, lidar, calibration, opencv]
    related_skills: [ros2, ros1, robotics-design-patterns]
---
