...
## Figure and chart discipline

- Prefer the muted house palettes already aligned with the system prompt rather than bright default plotting colors.
- For connector-facing chart requirements, keep labels high-contrast and compact while staying inside the muted palette family.
- prefer `mist-stone` for paper-neutral defaults: `#F3EEE8`, `#D8D1C7`, `#8A9199`
- use `sage-clay` when the main method-vs-baseline contrast needs one stronger but still restrained accent: `#E7E1D6`, `#B7A99A`, `#7F8F84`
...
- Connector-facing chart requirements:
  - preserve legibility after chat compression
  - avoid neon accents and overloaded legends
  - keep the main result visually dominant and baseline comparisons immediately readable
