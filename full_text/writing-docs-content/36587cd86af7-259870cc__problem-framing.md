...
composes_with:
  - package: "pm-skills"
    ...
    relation: "use_before"
    reason: "Problem-framing produces the brief that specification-writing turns into a buildable spec. Chain problem-framing -> specification-writing for any new initiative."
  - package: "pm-skills"
    skill: "competitive-market-analysis"
    relation: "complements"
    reason: "Problem-framing surfaces what to build; competitive-market-analysis confirms it's not already built. Run together for build-vs-adopt-vs-partner decisions."
  - package: "pm-skills"
    skill: "discovery-research"
    relation: "use_after"
    reason: "Problem-framing identifies evidence gaps; discovery-research closes them. Route to discovery-research when problem-framing flags a hypothesis needing validation."
  - package: "azure-skills"
    skill: "azure-diagnostics"
    relation: "use_after"
    reason: "When azure-diagnostics surfaces a telemetry-visible regression, route into problem-framing to interpret root cause and decide fix scope before any redesign."
  - package: "azure-skills"
    skill: "azure-kusto"
    relation: "use_after"
    reason: "A Kusto query that exposes a metric anomaly is a problem signal; problem-framing structures the response before remediation."
