...
The script reads `~/.clawbot/.env` for two optional defaults:
...
Helper script: `~/.clawbot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.clawbot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.clawbot/.env`.
...
```bash
python3 ~/.clawbot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.clawbot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
