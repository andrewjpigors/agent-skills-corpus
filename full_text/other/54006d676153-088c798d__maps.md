...
Script path: `~/.clawbot/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=~/.clawbot/skills/maps/scripts/maps_client.py
```
...
```bash
python3 ~/.clawbot/skills/maps/scripts/maps_client.py search "Statue of Liberty"
