...
## Rawclaw Agent Integration

This skill is designed for the Rawclaw agent. It uses Rawclaw tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Rawclaw skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.rawclaw/plans/` | `skill_view("plan")` |
