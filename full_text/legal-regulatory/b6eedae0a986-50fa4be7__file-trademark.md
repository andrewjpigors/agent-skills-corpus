...
name: file-trademark
title: 申请商标
description: 涵盖 EUIPO（欧盟）、USPTO（美国）和 WIPO Madrid Protocol（国际）的商标 申请步骤。引导您完成申请前冲突检查、Nice 分类、描述性评估、商标类型决策、 申请基础策略、办公室特定的电子申请步骤、Madrid Protocol 扩展、申请后监视 以及开源商标政策起草。在运行 screen-trademark 确认商标无冲突后、准备好 在一个或多个司法管辖区获取商标权时使用。
author: pjt222
