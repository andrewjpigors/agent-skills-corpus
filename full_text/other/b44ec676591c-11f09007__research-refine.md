...
Read `../../skills-codex/shared-references/autosci-lite-patterns.md` before Phase 1. Use its
...
`../../skills-codex/shared-references/autosci-lite-patterns.md`. Keep this to route selection,
...
> - **[Output Versioning Protocol](../../skills-codex/shared-references/output-versioning.md)** — write timestamped file first, then copy to fixed name
> - **[Output Manifest Protocol](../../skills-codex/shared-references/output-manifest.md)** — log every output to docs/project/OUTPUT_MANIFEST.md
> - **[Output Language Protocol](../../skills-codex/shared-references/output-language.md)** — respect the project's language setting
