...
2. **Indexes at every level.** Template: `.agents/skills/prd-templates/references/fractal-node-index-template.md`
3. **CX files at every level.** Template: `.agents/skills/prd-templates/references/fractal-cx-template.md`
4. **Feature files are leaf nodes.** Template: `.agents/skills/prd-templates/references/fractal-feature-template.md`
