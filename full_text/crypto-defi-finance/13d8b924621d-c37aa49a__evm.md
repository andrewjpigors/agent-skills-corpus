...
Helper script path: `~/.clawbot/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.clawbot/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.clawbot/skills/blockchain/evm/scripts/evm_client.py stats
```
