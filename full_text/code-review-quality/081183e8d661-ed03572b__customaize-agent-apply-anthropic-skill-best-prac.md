...
Apply skill authoring best practices to your skill.
...
- **Small/fast models** (e.g., Haiku-class): Does the Skill provide enough guidance?
- **Mid-tier models** (e.g., Sonnet-class): Is the Skill clear and efficient?
- **Large/reasoning models** (e.g., Opus-class): Does the Skill avoid over-explaining?
...
<Note>
  **YAML Frontmatter**: The SKILL.md frontmatter supports the following fields: `name`, `description`, `license`, `compatibility`, and `metadata`. Unknown fields are silently ignored.

- `name` - Human-readable name of the Skill (64 characters maximum)
- `description` - One-line description of what the Skill does and when to use it (1024 characters maximum)

  For complete Skill structure details, see the Skills documentation.
</Note>
...
SKILL.md serves as an overview that points the agent to detailed materials as needed, like a table of contents in an onboarding guide. For an explanation of how progressive disclosure works, see the Skills documentation.
...
The model's vision capabilities help understand layouts and structures.
...
Skills run in the code execution environment. Ensure required packages are available.

List required packages in your SKILL.md and verify they're available in the target environment.

### Runtime environment

Skills run in a code execution environment with filesystem access, bash commands, and code execution capabilities. See the Skills documentation for the conceptual explanation of this architecture.
...
For complete details on the technical architecture, see the Skills documentation.
...
The SKILL.md frontmatter includes `name` (64 characters max) and `description` (1024 characters max) fields, along with optional `license`, `compatibility`, and `metadata` fields. See the Skills documentation for complete structure details.

### Token budgets

Keep SKILL.md body under 500 lines for optimal performance. If your content exceeds this, split it into separate files using the progressive disclosure patterns described earlier. See the Skills documentation for architectural details.
...
- [ ] Tested with small, mid-tier, and large models
