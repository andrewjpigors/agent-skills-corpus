...
description: Use when working on ros2 web integration. rosbridge, FastAPI bridges, WebSocket streaming, REST APIs.
metadata:
  short-description: rosbridge, FastAPI bridges, WebSocket streaming, REST APIs
---
