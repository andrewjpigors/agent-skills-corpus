---
name: gcp-cloud-run
description: "Production-ready serverless on GCP — Cloud Run services (containerized), Cloud Run Functions (event-driven), cold-start optimization, and Pub/Sub event architecture. USE WHEN deploying or tuning Cloud Run containers/functions or wiring Pub/Sub-driven workloads on GCP."
