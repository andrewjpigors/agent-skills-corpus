...
description: Use when working on robot perception. Cameras, LiDAR, calibration, point clouds, sensor streaming, fusion.
metadata:
  short-description: Cameras, LiDAR, calibration, point clouds, sensor streaming, fusion
---
