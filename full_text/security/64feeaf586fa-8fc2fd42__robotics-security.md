...
description: Use when securing ROS2 communications with SROS2/DDS Security, hardening robot onboard computers, managing secrets and certificates, setting up network segmentation for robot fleets, or addressing the physical-cyber safety intersection in robot deployments.
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [robotics, security, sros2, dds, network, hardening]
    related_skills: [ros2, robot-bringup]
---
