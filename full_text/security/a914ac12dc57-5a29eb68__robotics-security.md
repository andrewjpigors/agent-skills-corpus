...
description: >
  Security hardening for robotic systems where cyber failures can create physical risk. Use
  when securing ROS2 or DDS communications, configuring SROS2 encryption and access control,
  hardening robot computers, managing certificates, credentials, firewalls, secure boot,
  network segmentation, robot fleet security, e-stop isolation, safety controller isolation,
  or IEC 62443-oriented robotics security.
---
