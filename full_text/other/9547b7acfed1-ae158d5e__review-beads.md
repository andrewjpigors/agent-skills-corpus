...
3. **Check br description field AND wired dependencies** — verify `br show <bead-id> --json` `.description` contains the full structured content; verify `br dep list <bead-id>` for dependency findings
...
*Skill Version: 2.14 — [Version History](VERSIONS.md)*
