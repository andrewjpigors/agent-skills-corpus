---
name: freelance-insurance-guide
description: |
  Guide freelance insurance needs and options.
  TRIGGERS - Use when user needs help with freelance-insurance-guide related tasks.
category: Freelance
version: 1.0
---
# freelance-insurance-guide
## Workflow
