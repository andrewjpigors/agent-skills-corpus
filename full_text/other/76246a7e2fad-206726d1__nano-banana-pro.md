...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.clawbot-plus/clawbot-plus.json`
...
- The script prints a `MEDIA:` line for ClawBot-Plus to auto-attach on supported chat providers.
